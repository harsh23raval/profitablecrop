...
def predict():
    ...
    if request.method == 'GET':
        ...
        urll = 'https://finalyield.herokuapp.com/yeild_predictor_api?area={}&state_name={}&district_name={}&crop={}&season={}&latitude={}&longitude={}'.format(area,state_name,district_name,crop_out,season,latitude,longitude)

        ress = requests.get(urll)
        dataa = ress.json()
        print(dataa)
        print(dataa["prediction"])

        d["profitable_crop_yeild_prediction"] = dataa["prediction"]
